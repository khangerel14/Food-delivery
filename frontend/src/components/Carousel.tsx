        ...
        <div className="flex bg-cover relative justify-center items-center">
            ...
            <div className="flex justify-between w-[1280px] absolute mx-auto">
                <div className="flex flex-col gap-5 mx-auto text-white w-[550px]">
                    ...
                    <hr />
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Pariatur rehv grieo natus eum, iste in nobis perferendis error eligendi magni possimus ex eos fugiat quae quod obcaecati sint ad optio ullam. Nihil.</p>
                </div>
                <div><Food /></div>
            </div>
        </div>
